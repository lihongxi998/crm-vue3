<template>
  <el-container class="layout-container">
    <el-aside :width="isCollapse ? '64px' : '220px'" class="layout-aside">
      <div class="logo">
        <el-icon class="logo-img" color="#409eff" size="24"><User /></el-icon>
        <span class="logo-text" v-show="!isCollapse">CRM 客户关系管理</span>
      </div>
      <el-menu
...
import {
  HomeFilled, User, Connection, Avatar, Promotion, Document, Money, Notebook,
  Fold, Expand
